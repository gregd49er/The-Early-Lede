	...
	public function meta_box_options(){
		...
		<div id="option_tabs">
		  <ul>
		    ...
		    <li><a href="#sk_meta">Custom meta</a></li>		    		    
		  </ul>
		  <div id="menu_tab">
			  	<?php
				 	...
				 	<div class="sk_admin_row">
				 		...
				 		<div class="sk_admin_span3">
					    	<?php
					    		...
					    		$logoURL = (isset($customPostOptions[0]['logoURL']))?$customPostOptions[0]['logoURL']:'#';					    	
					    	?>
				 		...
				 		<div class="sk_admin_span3">
							...
							<p>Logo URL</p>
							<input class="smallInputText" type="text" name="<?php echo $post_custom_meta_data;?>[logoURL]" value="<?php echo $logoURL;?>" />								
				 		</div>				 					 		
		  ...
		  <div id="sk_meta">
			    <p class="sk_notice"><strong>NOTE!</strong> Add custom HTML meta tags, <a href="http://www.w3schools.com/tags/tag_meta.asp" target="_blank">More about meta tags</a>.</p>
			    <?php
			    	$metaCustom = wptexturize((isset($customPostOptions[0]['metaCustom']))?$customPostOptions[0]['metaCustom']:'');
			    ?>
			    <textarea class="textareaInput" name="<?php echo $post_custom_meta_data;?>[metaCustom]"><?php echo $metaCustom;?></textarea>
		  </div>
	...
	public function meta_box_sections(){
		...
		<div id="sk_sectionsUI" class="optionBox" data-postmeta="<?php echo $this->getPostCustomMeta();?>">
			...
			<?php
				...
				//section 100% height
				$isFullHeightCBAC = (isset($customPostOptions[0]['isFullHeightCBAC']))?$customPostOptions[0]['isFullHeightCBAC']:false;
			...
			<div id="parallax_accordion">
				...
				<?php if(is_array($pTitles)):?>
					...
					<?php
						...
						//section is 100% full height
						$isFullHeightCBVal = (isset($isFullHeightCBAC[$i]))?$isFullHeightCBAC[$i]:'';
						$isFullHeightCBValChecked = ($isFullHeightCBVal=="on")?' checked':'';
						...
						<div class="px_group">
							 ...
							 <div>
							 	...
							 	<div class="sk_admin_row">
							 		...
							 		<div class="sk_admin_span3">
							 			<p class="pTitle"><strong>Force 100% min height</strong></p>
										<label class="checkbox">
										  <input class="isFullHeightCB" name="<?php echo $post_custom_meta_data;?>[isFullHeightCBAC][]" type="checkbox"<?php echo $isFullHeightCBValChecked;?>> Is 100 % min height
										</label>							 			
							 		</div>								 									 		
