		...
		<form method="post" action="options.php">
		  ...
		  <div id="optionsWrapper">	
			...
			<p class="submit">
		  	...
		  	<!--parallax tweenmax-->
		  	<div class="whiteOptionBox">
		  		<h2 class="optionsSecondTitle">TweenMax</h2>
		  		<div class="hLineTitle"></div>
		  		<?php		  			
					$isTweenMax = (isset($options['isTweenMaxON']))?$options['isTweenMaxON']:'';
					$isTweenMaxChecked = ($isTweenMax=="ON")?'checked':'';		  		
		  		?>		  		
		  		<input type="checkbox" name="<?php echo $this->getOptionGroup();?>[isTweenMaxON]" value="ON" <?php echo $isTweenMaxChecked;?>> Deactivate TweenMax animation library.
		  		<p class="sk_notice"><strong>NOTE!</strong>
		  			If your theme or another third party plugins loads another TweenMax version you can disable TweenMax that comes with Parallax Gravity. This way you can avoid conflicts between different versions of TweenMax. You can learn more about TweenMax Conflict &amp;&amp; Debug tips <a href="http://www.sakuraplugins.com/faq-support/" target="_blank">here</a>. 
		  		</p>		  		
