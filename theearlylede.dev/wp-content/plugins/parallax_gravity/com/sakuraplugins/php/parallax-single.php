...
<html lang="en">
  <head>
    ...
    <?php $gravity_engine->_eHTMLMetaTags();?>
    ...
    <link href='<?php echo $protocol;?>://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700' rel='stylesheet' type='text/css' />
    <?php wp_head(); ?> 
    <style type="text/css">
  ...
  <?php $gravity_engine->_eAnalytics();?>
		  	...
		  	<div class="container">
		  		<div class="row">
		  			...
		  			<?php if($gravity_engine->isPageLogo()):?>
			  			<div id="logoUI">
			  				<a href="<?php echo $gravity_engine->logoURL();?>"><img class="logoImage" src="<?php echo $gravity_engine->getLogoSrc();?>" alt=""></a>
			  			</div>
			  		<?php endif;?>
			  		<!--/if page logo-->			  			  			
	...
	<div class="gravityPage">
		...
		?>	
			<!--section-->
			<div id="<?php echo $gravity_engine->getStaticID($i);?>" data-isfullheight="<?php echo $gravity_engine->_eIsSectionFullHeight($i);?>" data-scrollduration="<?php echo $gravity_engine->getSectionScrollDuration($i);?>" class="gravitySection<?php echo $menuSectionClass;?>" data-hasbackgroundimage="<?php echo $backSettings['hasBackground'];?>" data-backimageurl="<?php echo $backSettings['backImageSrc'];?>" style="<?php echo $gravity_engine->getSectionCSS($i);?>">
